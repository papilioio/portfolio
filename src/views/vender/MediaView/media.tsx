...
const mediaArray: mediaDetail[] = [
  { title: 'メディア1', description: 'メディア概要テキスト' },
  { title: 'メディア2', description: 'メディア概要テキスト' },
  { title: 'メディア3', description: 'メディア概要テキスト' }
]
...
export default function ScenarioView() {
  ...
  return (
    <div>
      ...
      >
        {mediaArray.map((detail: mediaDetail) => (
